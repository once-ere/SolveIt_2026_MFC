...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::Problem2_14()
{
	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_HOMEWORK_COLLEGEPHYSICSSERWAYFAUGHN_PROBLEM214)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::Problem2_37()
{
	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_HOMEWORK_COLLEGEPHYSICSSERWAYFAUGHN_PROBLEM237)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::Example2_4()
{
//	Create_GenExampThread(ID_POPUP_HOMEWORK_COLLEGEPHYSICSSERWAYFAUGHN_EXAMPLE24)//theApp.Initialize();

	
	WM_APP_INIT_2("Example2_4.htm","Example 2.4")
...
// 3
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::Problem3_46()
{
	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_HOMEWORK_COLLEGEPHYSICSSERWAYFAUGHN_PROBLEM346)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::Problem3_51()
{
	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_HOMEWORK_COLLEGEPHYSICSSERWAYFAUGHN_PROBLEM351)//theApp.Initialize();
...
*/
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::Problem3_60()
{
	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_HOMEWORK_COLLEGEPHYSICSSERWAYFAUGHN_PROBLEM360)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::Example7_8()
{
	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_HOMEWORK_COLLEGEPHYSICSSERWAYFAUGHN_CHAPTER_7_EXAMPLE78)//theApp.Initialize();
