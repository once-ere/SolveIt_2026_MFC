...
///////////////////////////////////////////////////////////////////////////////
void CGenExamp::OnNewtonCradle2()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
///////////////////////////////////////////////////////////////////////////////
void CGenExamp::OnThreeBodyCollision()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
///////////////////////////////////////////////////////////////////////////////
void CGenExamp::OnFourBodyCollision()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
//!even with pivoting!!
void CGenExamp::OnFourBodyCollision2()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
	WRITE_LINE("system.name = \"Four Body Collision Approximation\";")
