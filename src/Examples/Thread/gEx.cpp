...
//system.stop reset
void CGenExamp::OnSimpleHarmonicOscillator()
{
...
//	Fire_WriteResponse(bstr);
	
}

void CGenExamp::OnResonantSimpleHarmonicOscillator()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
";
	...
	Fire_WriteResponse(bstr+bstr2);
	
}
void CGenExamp::OnCyclotron()
{
//	NewWebBrowser(2);
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
void CGenExamp::OnCubicAnharmonicOscillator()
{
//	NewWebBrowser(3);
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
void CGenExamp::OnAnharmonicOscillator()
{
//	NewWebBrowser(4);
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
///////////////////////////////////////////////////////////////////////////////
void CGenExamp::OnSimplePendulum()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
///////////////////////////////////////////////////////////////////////////////
void CGenExamp::OnPhysicalPendulum()
{
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
///////////////////////////////////////////////////////////////////////////////
void CGenExamp::OnCompoundPendulum()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
///////////////////////////////////////////////////////////////////////////////
void CGenExamp::OnSphereAndBlock()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
///////////////////////////////////////////////////////////////////////////////
void CGenExamp::OnTwoBodyScattering()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
///////////////////////////////////////////////////////////////////////////////
void CGenExamp::OnTwoBlocksAndPulley()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
//	WRITE_LINE("Floor.drawStyle = 0;")
	...
	WRITE_LINE("Pulley.color = [ 0.5, 0, 1 ];")
//	WRITE_LINE("Floor.color = [ 0.3 0.2 .1 ];")
...
*/
	...
	WRITE_LINE("Pulley.position = [ 0, 0, 0 ];")
	WRITE_LINE("Pulley.{[0, 0, 0]} == { [0, 0, 0] } 0;")
	WRITE_LINE("One.position = [  -0.2,  -1.0, 0 ];")
	WRITE_LINE("Two.position = [   0.2,  -.5, 0 ];")
//	WRITE_LINE("Floor.position = [    0.8  -0.1 0 ];")
...
///////////////////////////////////////////////////////////////////////////////
void CGenExamp::OnBlockAndTackle() {
	
}
///////////////////////////////////////////////////////////////////////////////
void CGenExamp::OnBlockAndPulley()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
//	WRITE_LINE("Two.connect.pulley == 0.2 1;")
	...
	WRITE_LINE("Two.height = .4;")
	WRITE_LINE("Two.depth =  .6;")
	WRITE_LINE("system.pulley Pulley.right == Two.quadrant 1;")
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CGenExamp::OnInelasticCollision()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
...
void CGenExamp::OnInelasticPendulumCollision()
{
	//Fire_ClearUserDefs();
	WM_APP_INIT///*theApp.PostThreadMessage(WM_APP_Initialize, 0, 0);*///WaitForSingleObject(g_EventInitialize, INFINITE);
