// Examples.cpp : implementation of the CSolveItView class
//
...
*/
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnMultiBodySlider()
{
//	
	Create_GenExampThread(ID_POPUP_MECHANICS_MULTIBODY_SLIDER)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnMultiMassSpring()
{
	Create_GenExampThread(ID_POPUP_MECHANICS_MultiMassSpring)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnMultiBodyTest()
{
	Create_GenExampThread(ID_POPUP_MECHANICS_MULTIBODY_TEST)//theApp.Initialize();
	WRITE_LINE("system.name = \"no action Test\";")
}
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnMultiBodyChain()
{
	Create_GenExampThread(ID_POPUP_MECHANICS_MULTIBODY_CHAIN)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnLennardJonesHeatedCooled()
{
	Create_GenExampThread(ID_POPUP_MECHANICS_LNNRDJNSPTNTLHEATEDCOOLED)//theApp.Initialize();
...
{
//	Create_GenExampThread(ID_POPUP_CHAOTIC_VERHULSTDYNAMICS)//theApp.Initialize();

	WM_APP_INIT_2("VerhulstDynamics.htm","Logistic Map")
