...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnOrbitalMechanics()
{

	Create_GenExampThread(ID_POPUP_GRAVITATION_ORBITALMECHANICS)//theApp.Initialize();
...
//	Create_GenExampThread(xxx)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnSunEarthMoon()
{

	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_GRAVITATION_SUNEARTHMOON)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnEarthMoon()
{

	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_GRAVITATION_EARTHMOON)//theApp.Initialize();
...
void CSolveItView::OnCannonBall()
{
/*
	...
	if (m_pCGenExamp)
	{
		...
		m_pCGenExamp->PostThreadMessage(ID_POPUP_PROJECTILE_CANNONBALL, 0, 0);
	}

	return;

	Create_GenExampThread(ID_POPUP_PROJECTILE_CANNONBALL)//theApp.Initialize();
*/
	WM_APP_INIT_2(0,0)
...
///////////////////////////////////////////////////////////////////////////////
	...
	WRITE_LINE("system.tic_mark.y = 51;")
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnSpline()
{
//	Create_GenExampThread(ID_POPUP_Spline)//theApp.Initialize();
	WM_APP_INIT_2("Spline.htm","Cubic Spline")
	WRITE_LINE("system.name = \"Spline of Data\";")

//	WRITE_LINE("system.boundingBox = [ -2.5 ,  2.5 ,  -2.5 ,  2.5 ,  2 , 42  ];")


	WRITE_LINE("system.data.file=\"work\\t.dat\";")
//	WRITE_LINE("system.data.file=\"t.dat\";")
/*
	std::wstring bstrQ=\
L"function Spline(x$)"
L"\r\n{"
...
*/
///////////////////////////////////////////////////////////////////////////////
	WRITE_LINE("function Spline(x$) {"
"	return spline(x);"
"}")
///////////////////////////////////////////////////////////////////////////////
	WRITE_LINE("Spline(0.7);");
//	WRITE_LINE("plot(\"Spline\", \" [x,-5, 5], [y ,  -1, 1] \");");
	WRITE_LINE("plot(\"Spline\", \" [x,-2*PI, 2*PI], [y ,  -1, 1] \");");
}
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnTestPlot()
{
	WM_APP_INIT_2(0,0)
	WRITE_LINE("system.name = \"Test Plot\";")
///////////////////////////////////////////////////////////////////////////////
	WRITE_LINE("function Q(r$) {\r\n"
"		L0=0.00573645;\r\n"
"		R=L0*r;\r\n"
"		a          = 2;\r\n"
"		d          = 0.2;\r\n"
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnTestRecursion()
{
	WM_APP_INIT_2(0,0)
	WRITE_LINE("system.name = \"Test Recursion\";")
/////////////////////////////////////////////////////////////////////////////////////
	WRITE_LINE("n=0;")
	WRITE_LINE("function ack(x$, y$) {\r\n"
"		n = n+1;\r\n"
"		if(x == 0) return (y+1);\r\n"
...
"}")
/////////////////////////////////////////////////////////////////////////////////////
	WRITE_LINE("write(\"ack(3, 3) should equal 61:\");")
	WRITE_LINE("ack(3, 3);")
	WRITE_LINE("write(\"The number of calls, n, should equal 2432:\");")
	WRITE_LINE("n;")
}
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnCrossProduct()
{

//	Create_GenExampThread(ID_POPUP_VECTORALGEBRA_CROSSPRODUCT)//theApp.Initialize();
	WM_APP_INIT_2("VectorAnalysis.htm","VectorAnalysis ")
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnSum()
{
//	Create_GenExampThread(ID_POPUP_VECTORALGEBRA_SUM)//theApp.Initialize();
	WM_APP_INIT_2("VectorAnalysis.htm","VectorAnalysis ")
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnDifference()
{
//	Create_GenExampThread(ID_POPUP_VECTORALGEBRA_DIFFERENCE)//theApp.Initialize();
	WM_APP_INIT_2("VectorAnalysis.htm","VectorAnalysis ")
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnPendulumAndFixedCharge()
{
	Create_GenExampThread(ID_POPUP_CHAOTIC_PENDULUMANDFIXEDCHARGE)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnPendulumAndPlanarCharge()
{
	//Fire_ClearUserDefs()PANTONEYellowCV;
	Create_GenExampThread(ID_POPUP_CHAOTIC_PENDULUMANDPLANARCHARGE)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnTrapping()
{
	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_CHAOTIC_TRAPPING)//theApp.Initialize();
	WRITE_LINE("system.name = \"\";")

	
}
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::On6Body() {
	Create_GenExampThread(ID_POPUP_CHAOTIC_6BODY)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnTwoNonShpericalBody()
{
	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_CHAOTIC_TWOBODY)//theApp.Initialize();
	WRITE_LINE("system.name = \"TwoNonShpericalBody\";")

	
}
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnThreeChargedBodies()
{
	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_ELECTROMAGNETIC_THREEBODY)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnChain()
{
//	Create_GenExampThread(ID_POPUP_CHAOTIC_CHAIN)//theApp.Initialize();

	WM_APP_INIT_2("Mandelbrot.htm", "Mandelbrot Set")
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnTwoBody()
{
	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_PROJECTILE_TWOBODY)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnThreeBody()
{
	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_PROJECTILE_THREEBODY)//theApp.Initialize();
...
///////////////////////////////////////////////////////////////////////////////
void CSolveItView::OnCurrentLoop()
{
	//Fire_ClearUserDefs();
	Create_GenExampThread(ID_POPUP_ELECTROMAGNETIC_CURRENTLOOP)//theApp.Initialize();
...
//	WRITE_LINE("s.velocity.x = 1;")
	...
	WRITE_LINE("s.magneticDipoleMoment=0;")
...
/*
	wstring& text = theSystem->m_strResponse;
	text = "\
