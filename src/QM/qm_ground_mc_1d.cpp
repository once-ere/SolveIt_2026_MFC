// qm_ground_mc_1d.cpp : implementation file
//

#include "stdafx.h"
#include "..\SolveIt.h"
#include "qm_ground_mc_1d.h"
#include "Cruncher.h"
#include "System.h"
#include "GLView.h"
...
IMPLEMENT_DYNCREATE(CQM_Ground_MC_1D, CWinThread)

CQM_Ground_MC_1D::CQM_Ground_MC_1D():
...
BOOL CQM_Ground_MC_1D::InitInstance()
{
	// TODO:  perform and per-thread initialization here
	return TRUE;
}

int CQM_Ground_MC_1D::ExitInstance()
{
	// TODO:  perform any per-thread cleanup here
	return CWinThread::ExitInstance();
}

BEGIN_MESSAGE_MAP(CQM_Ground_MC_1D, CWinThread)
	//{{AFX_MSG_MAP(CQM_Ground_MC_1D)
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void CQM_Ground_MC_1D::OnStepDone(WPARAM wParam, LPARAM lParam) 
{ 
	m_bStepCompleted=true; 
	Fire_ViewChange(); 
//	return 0; 
...
///////////////////////////////////////////////////////////////////////////////
void CQM_Ground_MC_1D::OnStep(WPARAM wParam, LPARAM lParam) 
{ 
...
///////////////////////////////////////////////////////////////////////////////
void CQM_Ground_MC_1D::OnHalt(WPARAM wParam, LPARAM lParam) 
{ 
	PostQuitMessage(0); 
//	return 0; 
}
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
long CQM_Ground_MC_1D::MakeTimeStep(void)
{
	CSystem* m_system	= theApp.GetSystem();
	try
	{
