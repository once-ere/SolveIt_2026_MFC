-(((R*(2*vx*x + 2*vy*y)*(vy*x - vx*y + 
      ...
      (R*(vy*x - vx*y + (R*(vx*x + vy*y))/Sqrt(Power(r,2) - Power(R,2)))*
         (2*(y - (R*(Sqrt(Power(r,2) - Power(R,2))*x + R*y))/Power(r,2))*
...
+ ((2*vx*x + 2*vy*y)*(-2*R*vx*x*y + R*vy*(Power(x,2) - Power(y,2))))/
    ...
    (-((R*Sqrt(Power(y - (R*(Sqrt(Power(r,2) - Power(R,2))*x + R*y))/
             ...
             Power(x - (R*(R*x - Sqrt(Power(r,2) - Power(R,2))*y))/
                Power(r,2),2))*
           ((x*(-y + (R*(Sqrt(Power(r,2) - Power(R,2))*x + R*y))/
                   Power(r,2)))/
              Sqrt(Power(y - 
                  (R*(Sqrt(Power(r,2) - Power(R,2))*x + R*y))/Power(r,2),
                 2) + Power(x - 
                  (R*(R*x - Sqrt(Power(r,2) - Power(R,2))*y))/Power(r,2),
                 2)) - (y*(-x + 
                  (R*(R*x - Sqrt(Power(r,2) - Power(R,2))*y))/Power(r,2))\
)/Sqrt(Power(y - (R*(Sqrt(Power(r,2) - Power(R,2))*x + R*y))/Power(r,2),
                 2) + Power(x - 
                  (R*(R*x - Sqrt(Power(r,2) - Power(R,2))*y))/Power(r,2),
                 2)) + (R*((y*
