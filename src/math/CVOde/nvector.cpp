...
N_Vector CVODE::N_VNew(integer N, void *machEnv)
{
  N_Vector v;
...
void CVODE::N_VLinearSum(real a, N_Vector x, real b, N_Vector y, N_Vector z)
{
  integer i, N;
  real c, *xd, *yd, *zd;
  N_Vector v1, v2;
...
void CVODE::N_VConst(real c, N_Vector z)
{
  integer i, N;
  real *zd;
...
void CVODE::N_VProd(N_Vector x, N_Vector y, N_Vector z)
{
  integer i, N;
  real *xd, *yd, *zd;
...
void CVODE::N_VDiv(N_Vector x, N_Vector y, N_Vector z)
{
  integer i, N;
  real *xd, *yd, *zd;
...
void CVODE::N_VScale(real c, N_Vector x, N_Vector z)
{
  integer i, N;
  real *xd, *zd;
...
void CVODE::N_VAbs(N_Vector x, N_Vector z)
{
  integer i, N;
  real *xd, *zd;
...
void CVODE::N_VInv(N_Vector x, N_Vector z)
{
  integer i, N;
  real *xd, *zd;
...
void CVODE::N_VAddConst(N_Vector x, real b, N_Vector z)
{
  integer i, N;
  real *xd, *zd;
...
real CVODE::N_VDotProd(N_Vector x, N_Vector y)
{
  integer i, N;
  real sum = ZERO, *xd, *yd;
...
real CVODE::N_VMaxNorm(N_Vector x)
{
  integer i, N;
  real max = ZERO, *xd;
...
real CVODE::N_VWrmsNorm(N_Vector x, N_Vector w)
{
  integer i, N;
...
real CVODE::N_VWL2Norm(N_Vector x, N_Vector w)
{
  integer i, N;
  real sum = ZERO, prodi, *xd, *wd;
...
real CVODE::N_VL1Norm(N_Vector x)
{
 integer i, N;
 real sum = ZERO, *xd;
...
void CVODE::N_VOneMask(N_Vector x)
{
  integer i, N;
  real *xd;
...
void CVODE::N_VCompare(real c, N_Vector x, N_Vector z)
{
  integer i, N;
  real *xd, *zd;
...
boole  CVODE::N_VInvTest(N_Vector x, N_Vector z)
{
  integer i, N;
  real *xd, *zd;
...
boole  CVODE::N_VConstrProdPos(N_Vector c, N_Vector x)
{
  integer i, N;
  real  *xd, *cd;
  boole test;
...
boole  CVODE::N_VConstrMask(N_Vector c, N_Vector x, N_Vector m)
{
  integer i, N;
  boole test;
  real *cd, *xd, *md;
...
real CVODE::N_VMinQuotient(N_Vector num, N_Vector denom)
{
  boole notEvenOnce;
  integer i, N;
  real *nd, *dd, min;
...
void CVODE::N_VPrint(N_Vector x)
{
  integer i, N;
  real *xd;
