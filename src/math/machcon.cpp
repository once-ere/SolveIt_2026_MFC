/* machcon.f -- translated by f2c (version 20020621).
...
doublereal r1mach_(integer *i__)
{
    ...
    static struct {
	doublereal e_1[5];
	} equiv_4 = { 1.18e-38, 3.4e38, 5.95e-8, 1.19e-7, .30102999566 };
...
#define rmach ((doublereal *)&equiv_4)
