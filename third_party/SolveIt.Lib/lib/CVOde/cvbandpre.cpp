...
CVBandPreData CVODE::CVBandPreAlloc(integer N, RhsFn f, void *f_data,
...
void CVODE::CVBandPreFree(CVBandPreData pdata)
{
  BandFreeMat(pdata->savedJ);
  BandFreeMat(pdata->savedP);
...
int CVODE::CVBandPrecond(integer N, real t, N_Vector y, N_Vector fy,
...
int CVODE::CVBandPSolve(integer N, real t, N_Vector y, N_Vector fy,
