! $Id: trlan77.f90,v 1.3 1998/10/17 00:58:57 kewu Exp $
!!!
...
!!!
	...
	LOGICAL(4) success
      ...
      OPEN (UNIT = 99, FILE = "log_io.txt", SHARE='DENYNONE')
      OPEN (UNIT = 98, FILE = "cpio.txt", SHARE='DENYNONE')
      OPEN (UNIT = 97, FILE = "fail.txt", SHARE='DENYNONE')


CALL ERSET (0, 0, 0) !Do not stop
	!success = SETENVQQ("FORT6=CONOUT.txt")
	!success = SETENVQQ("FOR_TYPE=CONOUT.txt")
	!success = SETENVQQ("FOR_PRINT=CONOUT.txt")

!      OPEN (UNIT = 6, FILE = 'QMStationary1D.txt')
