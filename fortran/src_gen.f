...
CC
CC  DOUBLE-PRECISION MACHINE CONSTANTS
CC
...
CC  D1MACH( 5) = LOG10(B)
CC
CC  TO ALTER THIS FUNCTION FOR A PARTICULAR ENVIRONMENT,
CC  THE DESIRED SET OF DATA STATEMENTS SHOULD BE ACTIVATED BY
CC  REMOVING THE C FROM COLUMN 1.
CC
CC  WHERE POSSIBLE, OCTAL OR HEXADECIMAL CONSTANTS HAVE BEEN USED
CC  TO SPECIFY THE CONSTANTS EXACTLY WHICH HAS IN SOME CASES
CC  REQUIRED THE USE OF EQUIVALENT INTEGER ARRAYS.
CC
C      INTEGER I
C      INTEGER SMALL(4)
C      INTEGER LARGE(4)
...
CC
CC     DATA SMALL(1) / 00604000000000000000B /
CC     DATA SMALL(2) / 00000000000000000000B /
CC
CC     DATA LARGE(1) / 37767777777777777777B /
CC     DATA LARGE(2) / 37167777777777777777B /
CC
CC     DATA RIGHT(1) / 15604000000000000000B /
CC     DATA RIGHT(2) / 15000000000000000000B /
CC
CC     DATA DIVER(1) / 15614000000000000000B /
CC     DATA DIVER(2) / 15010000000000000000B /
CC
...
CC
CC     DATA SMALL(1) / 200004000000000000000B /
CC     DATA SMALL(2) / 00000000000000000000B /
CC
CC     DATA LARGE(1) / 577777777777777777777B /
CC     DATA LARGE(2) / 000007777777777777777B /
CC
CC     DATA RIGHT(1) / 377214000000000000000B /
CC     DATA RIGHT(2) / 000000000000000000000B /
CC
CC     DATA DIVER(1) / 377224000000000000000B /
...
CC     STATIC DMACH(5)
CC
CC     DATA SMALL/20K,3*0/,LARGE/77777K,3*177777K/
CC     DATA RIGHT/31420K,3*0/,DIVER/32020K,3*0/
...
CC
CC     MACHINE CONSTANTS FOR IEEE ARITHMETIC MACHINES, SUCH AS IBM PC
CC
CC     DATA SMALL(1),SMALL(2) / 0 , 1048576 /
CC     DATA LARGE(1),LARGE(2) / -1 , 2146435071 /
CC     DATA RIGHT(1),RIGHT(2) / 0 , 1017118720 /
CC     DATA DIVER(1),DIVER(2) / 0 , 1018167296 /
CC     DATA LOG10(1),LOG10(2) / 1352628735 , 1070810131 /
CC
CC     MACHINE CONSTANTS FOR IEEE ARITHMETIC MACHINES, SUCH AS SUN SPARC
CC
